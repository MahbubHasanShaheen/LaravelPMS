...
@section('content')
 ...
 <div class="container">
    ...
    @if ($errors->any())
         ...
         <a class="card-title">Update Year Spend</a>
         

    </div>


  <form  action="{{ url('spend/year-update/'.$year->id) }}" method="POST">
            @csrf 
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="details" value="{{ $year->details }}">
        </div>

        <div class="form-group">
            <label for="name">Sepend Amount</label>
            <input type="text" class="form-control" name="amount" value="{{ $year->amount }}">
        </div>
        ...
        <!--<div class="form-group">
            ...
            <input type="text" class="form-control" name="year" value="{{ date('F')}}">
