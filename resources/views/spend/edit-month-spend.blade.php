...
@section('content')
 ...
 <div class="container">
    ...
    @if ($errors->any())
         ...
         <a class="card-title">Update month Spend</a>
         

    </div>


  <form  action="{{ url('spend/month-update/'.$month->id) }}" method="POST">
            @csrf 
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="details" value="{{ $month->details }}">
        </div>

        <div class="form-group">
            <label for="name">Sepend Amount</label>
            <input type="text" class="form-control" name="amount" value="{{ $month->amount }}">
        </div>
