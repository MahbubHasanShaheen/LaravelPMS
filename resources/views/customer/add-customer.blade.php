...
@section('content')
 ...
 <div class="container">
  ...
  <form  action="{{ url('customer/customer-store') }}" method="POST" enctype="multipart/form-data">
            @csrf 
        <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="banck_account" placeholder="Enter Banck Account No..">
        </div>
